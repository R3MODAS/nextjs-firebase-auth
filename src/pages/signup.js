        ...
        <div className='container my-4' style={{ width: "60%", margin: "auto" }}>
            <form onSubmit={handleSignup}>
                ...
                <div className='text-center'>
                    <button className="btn btn-primary mx-3 my-1" type='submit'>Signup</button>
                  <button className='btn btn-success my-1'><Link href="/login" className='text-light'>Go to Login</Link></button>  
                </div>
